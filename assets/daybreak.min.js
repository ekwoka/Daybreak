...
`, el);
  ...
  var Alpine2 = {
    ...
    version: "DAYBREAK custom v3.4.1",
...
|____/ \\__,_|\\__, |_.__/|_|  \\___|\\__,_|_|\\_\\
  ...
  async function addToCart(id, q, items) {
    ...
    try {
      ...
      if (item.status == "bad_request" || item.status == 404)
    ...
    index >= 0 && ((_a2 = items[index]) == null ? void 0 : _a2.removed) && items.splice(index, 1) && (index = -1);
  ...
  var _a;
  var currency = new Intl.NumberFormat([Shopify.locale + "-" + Shopify.country], { style: "currency", currency: ((_a = Shopify == null ? void 0 : Shopify.currency) == null ? void 0 : _a.active) || "USD" }) || new Intl.NumberFormat([en - US], { style: "currency", currency: USD });
  var RIAS = {
    updateSize(el) {
  ...
  function alpinescript_default(Alpine3) {
    console.log("Registering Storage");
    window.__daybreaks = {};
    Alpine3.persistedStore = function(name, value, storage = localStorage) {
    ...
    Alpine3.persistedStore("subscribed", false);
    Alpine3.persistedStore("recentlyViewed", {
      items: [],
      next: {},
      init() {
        if (!this.next.id)
          return;
        if (this.items.some((i) => i.id == this.next.id))
          return;
    ...
    Alpine3.data("emailCapture", ({
      ...
      async submitEmail() {
        ...
        if ((_a2 = data == null ? void 0 : data.data) == null ? void 0 : _a2.is_subscribed)
    ...
    Alpine3.data("productForm", ({ title } = {}) => ({
      form: false,
      sending: false,
      title: title || "product",
      async addToCart() {
